...
#if LV_VERSION_CHECK(9,0,0)
lv_display_t * disp = lv_display_create(BOARD_TFT_WIDTH, BOARD_TFT_HEIHT);

#ifdef BOARD_HAS_PSRAM
    lv_display_set_buffers(disp, buf1, buf1, BOARD_TFT_WIDTH * BOARD_TFT_HEIHT, LV_DISP_RENDER_MODE_PARTIAL);
#else
