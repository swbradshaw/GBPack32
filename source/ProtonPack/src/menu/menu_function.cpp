...
// *********************************************************************
{
  if (LCDML.FUNC_setup()) // ****** SETUP *********
  {
    ...
    do
    {
      u8g2.drawStr(0, (getFontHeight() * 1), "To close this");
      u8g2.drawStr(0, (getFontHeight() * 2), "function press");
      u8g2.drawStr(0, (getFontHeight() * 3), "any button or use");
      u8g2.drawStr(0, (getFontHeight() * 4), "back button");
    } while (u8g2.nextPage());
  }
...
// *********************************************************************
{
  if (LCDML.FUNC_setup()) // ****** SETUP *********
  {
    ...
    do
    {
      u8g2.drawStr(0, (getFontHeight() * 1), buf);
      u8g2.drawStr(0, (getFontHeight() * 2), "or press back button");
    } while (u8g2.nextPage());
...
// *********************************************************************
{
  if (LCDML.FUNC_setup()) // ****** SETUP *********
  {
    ...
    do
    {
      u8g2.drawStr(0, (getFontHeight() * 1), "press a or w button");
      u8g2.drawStr(0, (getFontHeight() * 2), buf);
    } while (u8g2.nextPage());
...
// *********************************************************************
void mFunc_changeTheme(uint8_t theme)
// *********************************************************************
{
  if (LCDML.FUNC_setup()) // ****** SETUP *********
  {
    ...
    EventArgs args;
    args.eventName = EVENT_THEME_CHANGE;
    args.eventDetail1 = String(theme);
    audioEngine.dispatchEvent(args);
    // send event to change theme
    debugln("Theme changed to: " + String(theme));
...
void mFunc_vent(uint8_t ventLength)
// *********************************************************************
{
  if (LCDML.FUNC_setup()) // ****** SETUP *********
  {
    ...
    args.eventDetail1 = String(ventLength * 1000);
    // getEventEngine()->notify(args);
    eventEngine.notify(args);
    debugln("Vent event sent " + args.eventDetail1);
...
// *********************************************************************
{
  if (LCDML.FUNC_setup()) // ****** SETUP *********
  {
    ...
    {
      u8g2.drawStr(0, (getFontHeight() * 1), buf);
      u8g2.drawStr(0, (getFontHeight() * 2), "press any key");
      u8g2.drawStr(0, (getFontHeight() * 3), "to leave it");
    } while (u8g2.nextPage());
...
// *********************************************************************
bool COND_hide() // hide a menu element
// *********************************************************************
{
  return false; // hidden
}